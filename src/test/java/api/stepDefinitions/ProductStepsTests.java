...
import ui.stepDefinitions.SignUpSteps;
...
public class ProductStepsTests {
    ...
    Logger logger = LogManager.getLogger(SignUpSteps.class);
    ...
    public void base_url(String baseUrl) {
        ...
        logger.info("building request with base url:" + baseUrl);
    }
    ...
    public void i_have_with_in_request_body(String key, String value) {
        ...
        logger.info("building request body with key: " + key + "and value: " + value);
    }
    ...
    public void i_send_post_request() {
        ...
        logger.info("response from post request: " + response.prettyPrint());
    }
